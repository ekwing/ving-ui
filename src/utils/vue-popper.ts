...
@Component
export default class PopperComponent extends Vue {
  @Prop()
  ...
  @Prop({ default: true })
  private transformOrigin!: boolean | string

  @Prop({ default: 'bottom' })
  private placement!: string

  @Prop({ default: 5 })
  private boundariesPadding!: number
  ...
  appendArrow(element: HTMLElement) {
    let hash
    if (this.appended) {
      return
    }
